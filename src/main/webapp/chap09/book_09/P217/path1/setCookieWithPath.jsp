...
<%
	Cookie cookie1 = new Cookie("path1",
		URLEncoder.encode("경로:/jsp20220923/chap09/book_09/P217/path1","utf-8"));
	cookie1.setPath("/jsp20220923/chap09/book_09/P217/path1");
	...
	Cookie cookie4 = new Cookie("path4",
		URLEncoder.encode("경로:/jsp20220923/chap09/book_09/P217/path2","utf-8"));
